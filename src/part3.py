...
<div class="card analogy">
  ...
  然后<strong>当场给你一张回执</strong>（HTTP 207），就让你走了——<strong>不会</strong>当着你的面去分拣、称重、送到目的地。那些慢活，传送带后面的人（worker）慢慢做。
...
_ZH12.append(r"""
<div class="fig">
<svg viewBox="0 0 720 200" role="img" aria-label="摄取请求的生命周期：鉴权、Zod 校验、processEventBatch 入队、立即返回 207">
  ...
  <rect x="590" y="70" width="110" height="50" rx="10" fill="var(--blue-soft)" stroke="var(--blue)"/><text x="645" y="92" text-anchor="middle" font-size="10.5" font-weight="700" fill="var(--ink)">207</text><text x="645" y="108" text-anchor="middle" font-size="8.5" fill="var(--muted)">立即返回</text>
...
<div class="card analogy">
  ...
  belt</strong> (enqueue). Then it <strong>hands you a receipt on the spot</strong> (HTTP 207) and lets you go — it <strong>won't</strong> sort,
...
<svg viewBox="0 0 720 200" role="img" aria-label="ingestion request lifecycle: auth, Zod validation, processEventBatch enqueue, immediate 207">
  ...
  <rect x="590" y="70" width="110" height="50" rx="10" fill="var(--blue-soft)" stroke="var(--blue)"/><text x="645" y="92" text-anchor="middle" font-size="10.5" font-weight="700" fill="var(--ink)">207</text><text x="645" y="108" text-anchor="middle" font-size="8.5" fill="var(--muted)">return now</text>
  <line x1="140" y1="95" x2="158" y2="95" stroke="var(--faint)" stroke-width="1.8"/><polygon points="158,95 149,90 149,100" fill="var(--faint)"/>
  <line x1="270" y1="95" x2="288" y2="95" stroke="var(--faint)" stroke-width="1.8"/><polygon points="288,95 279,90 279,100" fill="var(--faint)"/>
  <line x1="400" y1="95" x2="418" y2="95" stroke="var(--faint)" stroke-width="1.8"/><polygon points="418,95 409,90 409,100" fill="var(--faint)"/>
  <line x1="570" y1="95" x2="588" y2="95" stroke="var(--faint)" stroke-width="1.8"/><polygon points="588,95 579,90 579,100" fill="var(--faint)"/>
...
有趣的是，第 3 课提到的那些新观测类型——AGENT / TOOL / CHAIN / RETRIEVER / EVALUATOR / EMBEDDING / GUARDRAIL——它们的 <code>body</code> <strong>全都复用 <code>CreateGenerationBody</code></strong>：
...
the newer observation types from Lesson 3 — AGENT / TOOL / CHAIN / RETRIEVER / EVALUATOR / EMBEDDING / GUARDRAIL — <strong>all reuse
...
<div class="card key">
  ...
  <ul>
    ...
    <li><strong>韧性</strong>：任务 <code>attempts: 6</code>（次级队列为 5）+ 指数退避；成功即删、失败保留。队列 + S3 = 削峰 + 容错 + 可重放。</li>
  </ul>
</div>
""")
...
<div class="card key">
  ...
  <ul>
    ...
    <li><strong>Resilience</strong>: jobs use <code>attempts: 6</code> (secondary queue: 5) + exponential backoff; removed on success, kept on failure. Queue + S3 = spike absorption + fault tolerance + replayability.</li>
  </ul>
</div>
""")
LESSON_14 = {"zh": "\n".join(_ZH14), "en": "\n".join(_EN14)}
